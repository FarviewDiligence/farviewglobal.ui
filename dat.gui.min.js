...
!function(e, t) {
    ...
    function d(e) {
        e.style.background = "",
        e.style.cssText += "background: -moz-linear-gradient(top,rgb(0, 59, 162) 0%,rgb(0, 249, 208) 17%, #0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%,rgb(138, 140, 0) 100%);",
        e.style.cssText += "background: -webkit-linear-gradient(top,rgb(2, 165, 163) 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);",
        e.style.cssText += "background: -o-linear-gradient(top,rgb(25, 187, 146) 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);",
        e.style.cssText += "background: -ms-linear-gradient(top,rgb(4, 88, 166) 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);",
        e.style.cssText += "background: linear-gradient(top,rgb(10, 48, 203) 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);"
    }
    function c(e, t, n) {
